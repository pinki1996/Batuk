...
<div class="whole">
	<div class="login">
		...
		<?php } ?>
		<p class="title">		<img src="../images/icon_users.png" width="200" height="50" align="middle" ><br>
Administrator Login panel<hr></p>
		<form name="frmlogin" method="post" action="dashboard.php">
...
if(isset($_POST['submit'])) {
	...
	$level=$_POST['level'];
	if($level=="main"){
	$sql = "select * from table_user where admin_username='$username' and password='$password'";
