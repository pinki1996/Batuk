...
$cat_id = $_GET['id'];
$cat_query = "select * from table_catagory where id= $cat_id";
$cat_data=mysqli_query($mysqli,$cat_query);

$product_query = "select * from product where cat_id= $cat_id";
$product_data=mysqli_query($mysqli,$product_query);
		...
		<div class="container">
			...
			<div class="w3ls_logo_products_left1">
				<ul class="special_items">
					...
					<li><a href="admin/login-adm.php">admin login</a></li>
				</ul>
			</div>
			<div class="w3ls_logo_products_left1">
				<ul class="phone_email">
					<li><i class="fa fa-phone" aria-hidden="true"></i>9045808334</li>
					<li><i class="fa fa-envelope-o" aria-hidden="true"></i><a href="mailto:thesharabh@gmail.com">thesharabh@gmail.com</a></li>
				</ul>
			</div>
			<div class="clearfix"> </div>
		</div>
...
<!-- products-breadcrumb -->
	<div class="products-breadcrumb">
		<div class="container">
			<ul>
				<li><i class="fa fa-home" aria-hidden="true"></i><a href="category.php">Home</a><span>|</span></li>
		...
		<div class="w3l_banner_nav_left">
			  ...
			  <div class="navbar-header nav_2">
			   ...
			   <!-- Collect the nav links, forms, and other content for toggling -->
				...
				<?php	} ?>
						...
						<?php
                    while($result=mysqli_fetch_assoc($cat_data))
                    { ?>
						<img src="adminp/images/<?php echo $result['picsource'] ?>" alt=" " class="img-responsive" />
					<?php } ?>
											<div class="mask">
							<h4>Metals</h4>
			...
			<div class="w3ls_w3l_banner_nav_right_grid">
				...
				<div class="w3ls_w3l_banner_nav_right_grid1">
						...
						<?php
					$product_array = array();
                    while($result=mysqli_fetch_assoc($product_data))
                    { 
                    	$product_array[] = $result;
                    }

	                  $product_len = count($product_array);
	                  $no_of_rows = ceil($product_len/4);
	                  $k = 0;
	                  for($i=1; $i<=$no_of_rows; $i++){

	                  	for($j = 1; $j <=4 && isset($product_array[$k]); $j++){
								...
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<p><?php echo $result=mysqli_fetch_assoc($cat_data)?> <img src="adminp/images/<?php echo $product_array[$k]['picsource'] ?>" alt=" "/></p>
											<p><?php echo $product_array[$k]['name'] ?></p>
											<h4><?php echo $product_array[$k]['price']. "Rs"?></h4>
											<p><?php echo $product_array[$k]['quantity'] ?></p>

											

										</div>
										<div class="snipcart-details">
											<form method="post" action="cart.php?action=add&id=<?php echo $product_array[$k]["id"]; ?>">
								...
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											...
											<h4><?php echo $result['price']. "Rs" ?> <!-- <span>$3.00</span> --></h4>
